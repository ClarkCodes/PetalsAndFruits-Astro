...
export default async function seed() {
	...
	await db.insert( ProductService ).values([
		...
		{ 
			...
			ps_price: 10.00, 
			ps_img_path: '/src/assets/images/Paternal.webp',
		...
		{ 
			...
			ps_price: 11.99, 
			ps_img_path: '/src/assets/images/Seniorial.jpg',
			alt: 'Arreglo Señorial'
		},
		{ 
			id_ps: 13, 
			ps_name: 'Tulipanes Paternales', 
			id_pstype: 1, 
			id_pscategory: 4, 
			ps_description: 'Tulipanes para aquellos de gustos específicos, con un color vibrante', 
			ps_price: 9.99, 
			ps_img_path: '/src/assets/images/Tulipanes_1280.jpg',
			alt: 'Tulipanes Paternales'
		},
		{ 
			id_ps: 14, 
			ps_name: 'Florero Imperial', 
			id_pstype: 1, 
			id_pscategory: 4, 
			...
			ps_price: 15.99, 
			ps_img_path: '/src/assets/images/vase-Imperial_1280.jpg',
			alt: 'Florero Imperial'
		},
		{ 
			id_ps: 15, 
			ps_name: 'Caja Presente de Rosas', 
			id_pstype: 1, 
			id_pscategory: 5, 
			ps_description: 'Rosas Blancas y Amarillas en una caja de obsequio con un lacito, elegante y detallista', 
			ps_price: 24.99, 
			ps_img_path: '/src/assets/images/Bouquet-RosasBlancasAmarillas_1280.jpg',
			alt: 'Rosas Blancas y Amarillas'
		},
		{ 
			id_ps: 16, 
			ps_name: 'Bouquet Austral', 
			id_pstype: 1, 
			id_pscategory: 5, 
			...
			ps_price: 12.99, 
			ps_img_path: '/src/assets/images/Bouquet-RosasBlancasLirios_1280.jpg',
			alt: 'Bouquet de Rosas Blancas y Lirios'
		},
		{ 
			id_ps: 17, 
			ps_name: 'Bouquet Colorido Diverso', 
			id_pstype: 1, 
			id_pscategory: 5, 
			...
			ps_price: 21.99, 
			ps_img_path: '/src/assets/images/Bouquet-ColoridoDiverso_1280.jpg',
			alt: 'Bouquet Colorido Diverso'
		},
		{ 
			id_ps: 18, 
			ps_name: 'Canasta Sol Rosa', 
			id_pstype: 1, 
			id_pscategory: 5, 
			ps_description: 'Canasta de Girasoles con Rosas, acojedor y de estilo hogareño', 
			ps_price: 18.99, 
			ps_img_path: '/src/assets/images/Canasta-GirasolesRosasClaras_1280.jpg',
			alt: 'Canasta de Girasoles y Rosas Claras'
		},
		{ 
			id_ps: 19, 
			ps_name: 'Berry Sandia', 
			id_pstype: 2, 
			id_pscategory: 6, 
			ps_description: 'Frutas tropicales frescas: sandia, arándanos, moras y frambuesas', 
			ps_price: 9.99, 
			ps_img_path: '/src/assets/images/Frutal_Gourmet_BerrySandia_1280.jpg',
			alt: 'Berry Sandia'
		},
		{ 
			id_ps: 20, 
			...
			ps_price: 5.50, 
			ps_img_path: '/src/assets/images/Frutal_Gourmet_Piqueos-2048x2048.jpg',
			alt: 'Piqueos'
		},
		{ 
			id_ps: 21, 
			ps_name: 'Copa Saludable', 
			id_pstype: 2, 
			id_pscategory: 6, 
			ps_description: 'Una copa con frutas adecuadas, tanto diuréticas como para el sistema digestivo', 
			ps_price: 7.00, 
			ps_img_path: '/src/assets/images/Frutal_Gourmet_CopaSaludable-2048x2048.jpg',
			alt: 'Copa Saludable'
		},
		{ 
			id_ps: 22, 
			...
			ps_price: 11.99, 
			ps_img_path: '/src/assets/images/Frutales_Gourmet_SunnyBlue-2048x2048.jpg',
			alt: 'Sunny Blue'
		},
		{ 
			id_ps: 23, 
			...
			ps_price: 15.99, 
			ps_img_path: '/src/assets/images/Frutales_Gourmet_Degustacion-2048x2048.jpg',
			alt: 'Degustación'
		},
		{ 
			id_ps: 24, 
			ps_name: 'Rebanadas Frutales', 
			id_pstype: 2, 
			id_pscategory: 6, 
			ps_description: 'Una bandeja variada de frutas cortadas en rodajas y rebanadas, ideal para comer en la mañana y compartir', 
			ps_price: 2.99, 
			ps_img_path: '/src/assets/images/Frutales_Gourmet_RebanadasFrutales-2048x2048.webp',
			alt: 'Rebanadas Frutales'
		},
		{ 
			id_ps: 25, 
			ps_name: 'Bañado Parcial', 
			id_pstype: 2, 
			id_pscategory: 7, 
			...
			ps_price: 13.99, 
			ps_img_path: '/src/assets/images/Frutales_ChocoFresas_BaniadoParcial-2048x2048.jpg',
			alt: 'Bañado Parcial'
		},
		{ 
			id_ps: 26, 
			...
			ps_price: 15.99, 
			ps_img_path: '/src/assets/images/Frutales_ChocoFresas_Multisabor-2048x2048.jpg',
			alt: 'Multisabor'
		},
		{ 
			id_ps: 27, 
			...
			ps_price: 14.99, 
			ps_img_path: '/src/assets/images/Frutales_ChocoFresas_Empastadas-2048x2048.jpg',
			alt: 'Empastadas'
		},
		{ 
			id_ps: 28, 
			ps_name: 'Glaciares Magnum', 
			id_pstype: 2, 
			id_pscategory: 7, 
			...
			ps_price: 20.99, 
			ps_img_path: '/src/assets/images/Frutales_ChcoFresas_GlaciaresMagnum-2048x2048.jpg',
			alt: 'Glaciares Magnum'
		},
		{ 
			id_ps: 29, 
			ps_name: 'Fresas de Pascua', 
			id_pstype: 2, 
			id_pscategory: 7, 
			...
			ps_price: 17.99, 
			ps_img_path: '/src/assets/images/Frutales_ChocoFresas_Fresas de Pascua-2048x2048.jpg',
		...
		{ 
			...
			ps_price: 10.99, 
			ps_img_path: '/src/assets/images/Frutal_Elegante_Plenitud.jpg',
			alt: 'Plenitud'
		},
		{ 
			id_ps: 31, 
			ps_name: 'Frescura Palmerina', 
			id_pstype: 2, 
			id_pscategory: 8, 
			ps_description: 'Fresas, melón, uvas y piña, en una arreglo con motivo de palmera, esteticamente elaborado', 
			ps_price: 8.99, 
			ps_img_path: '/src/assets/images/Frutal_Elegante_FrescuraPalmerina.webp',
			alt: 'Frescura Palmerina'
		},
		{ 
			id_ps: 32, 
			ps_name: 'Piña Hawaiana', 
			id_pstype: 2, 
			id_pscategory: 8, 
			ps_description: 'Alta dotación de Piña Hawaiana con fresas, delicioso para cualquier amante de la piña', 
			ps_price: 12.99, 
			ps_img_path: '/src/assets/images/Frutal_Elegante_PiniaHawaiana.jpg',
			alt: 'Piña Hawaiana'
		},
		{ 
			id_ps: 33, 
			...
			ps_price: 3.00, 
			ps_img_path: '/src/assets/images/Frutal_Surtido_Personal.jpg',
			alt: 'Personal'
		},
		{ 
			id_ps: 34, 
			...
			ps_price: 18.99, 
			ps_img_path: '/src/assets/images/Frutal_Surtido_Familiar_1280.jpg',
			alt: 'Familiar'
		},
		{ 
			id_ps: 35, 
			ps_name: 'Canasta Poderosa', 
			id_pstype: 2, 
			id_pscategory: 9, 
			ps_description: 'Una Gran Canasta con muchas frutas variadas, de pequeño y mediano tamaño', 
			ps_price: 19.99, 
			ps_img_path: '/src/assets/images/Frutal_Surtido_CanastaPoderosa_1280.png',
		...
		{ 
			...
			ps_price: 10.99, 
			ps_img_path: '/src/assets/images/Frutal_Infantil_Fiestero.webp',
			alt: 'Fiestero'
		},
		{ 
			id_ps: 37, 
			ps_name: 'Canastita Feliz', 
			id_pstype: 2, 
			id_pscategory: 10, 
			...
			ps_price: 14.99, 
			ps_img_path: '/src/assets/images/Frutal_Infantiles_CanastitaFeliz-2048x2048.webp',
			alt: 'Canastita Feliz'
		},
		{ 
			id_ps: 38, 
			ps_name: 'Canastón Grupal', 
			id_pstype: 2, 
			id_pscategory: 10, 
			ps_description: 'Vaso Grande con frutas variadas como Fresas, Uvas, Piña y Naranja, ideal para compartir en grupo', 
			ps_price: 20.99, 
			ps_img_path: '/src/assets/images/Frutal_Infantil_CanastonGrupal-2048x2048.webp',
			alt: 'Canastón Grupal'
		},
		{ 
			id_ps: 39, 
			ps_name: 'Jarritos Frutales', 
			id_pstype: 2, 
			id_pscategory: 10, 
			...
			ps_price: 5.99, 
			ps_img_path: '/src/assets/images/Frutal_Infantil_JarrosFrutales-2048x2048.jpg',
	...
	await db.insert( SaleHistory ).values([
		{ 
			...
			id_ps: 10, 
			quant: 2, 
			sale_date: new Date( "2022/02/03" )
		},
		{ 
			id_sale: 2, 
			id_ps: 4, 
			quant: 8, 
			sale_date:  new Date( "2022/02/05" ) 
		},
		{ 
			id_sale: 3, 
			id_ps: 2, 
			quant: 3, 
			sale_date:  new Date( "2022/02/10" ) 
		},
		{ 
			id_sale: 4, 
			id_ps: 7, 
			quant: 5, 
			sale_date:  new Date( "2022/03/15" ) 
		},
		{ 
			id_sale: 5, 
			id_ps: 6, 
			quant: 1, 
			sale_date:  new Date( "2022/03/25" ) 
		},
		{ 
			id_sale: 6, 
			id_ps: 1, 
			quant: 3, 
			sale_date:  new Date( "2022/05/07" ) 
		},
		{ 
			id_sale: 7, 
			id_ps: 3, 
			quant: 1, 
			sale_date:  new Date( "2022/07/09" ) 
		},
		{ 
			id_sale: 8, 
			id_ps: 8, 
			quant: 2, 
			sale_date:  new Date( "2023/10/19" ) 
		},
		{ 
			id_sale: 9, 
			id_ps: 4, 
			quant: 4, 
			sale_date:  new Date( "2023/05/21" ) 
		},
		{ 
			id_sale: 10, 
			id_ps: 9, 
			quant: 2, 
			sale_date: new Date( "2023/08/03" ) 
		},
		{ 
			id_sale: 11, 
			id_ps: 10, 
			quant: 1, 
			sale_date:new Date( "2023/11/10" ) 
		},
		{ 
			id_sale: 12, 
			id_ps: 2, 
			quant: 5, 
			sale_date: new Date( "2024/01/03" ) 
		},
		{ 
			id_sale: 13, 
			id_ps: 7, 
			quant: 7, 
			sale_date: new Date( "2024/02/11" ) 
		},
		{ 
			id_sale: 14, 
			id_ps: 9, 
			quant: 3, 
			sale_date: new Date( "2024/03/22" ) 
		},
		{ 
			id_sale: 15, 
			id_ps: 1, 
			quant: 2, 
			sale_date: new Date( "2024/04/05" ) 
		},
	]);
}
